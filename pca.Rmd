...
pca1 <- prcomp(annual[keep_polluants], center = T, scale. = T, 
               #rank. = 3
               )
...
# relabel
rownames(pca1$rotation) <- pollutant_levels2
...
autoplot(pca1, scale = 0, loadings = TRUE, loadings.label = T) 
...
ggsave(file.path(image_path, "pca_plot.png"), width = 6, height = 6)
