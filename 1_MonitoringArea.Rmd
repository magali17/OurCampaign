...
# # TEST
# map0 + 
#   #geom_sf(data=test, inherit.aes = F) +
# #new monitoring region
#   geom_sf(data=monitoring_area_shp2, #routes_shp2,
#         #aes(col = Route), 
#         inherit.aes = F, 
#         lwd = 0.3, alpha = 0.3, #alpha=0.7
#         ) + 
# # lines
...
saveRDS(water_shp1, file.path("Data", "Output", "GIS", "monitoring_land_shp.rda"))
...
ggsave(file.path("..", "Manuscript", "Images", "monitoring_map_inset.jpg"), width = 7.5, height = 10)
