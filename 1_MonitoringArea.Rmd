...
st_write(monitoring_area_shp2, file.path("Data", "Output", "GIS", "monitoring_area.shp"))
...
st_write(water_shp1, file.path("Data", "Output", "GIS", "water_nearby.shp"))
...
st_write(monitoring_land, file.path("Data", "Output", "GIS", "monitoring_land.shp"))
