...
doe <- doe0 %>%
  ...
  mutate(
    #tell R time is in PST. need this to merge correctly later w/ mobile monitoroing data. otherwise, R thinks this is in UTC.
    time = with_tz(time, tzone = mytz),
...
doe_colo <- dt_stops3_colo %>%
  ...
  drop_na() %>%# View()
  #calculate 2-min avg - same as median for 2 numbers.
...
for (i in seq_along(locs)) {
  ...
  p[[i]] <- dt_doe %>%
    ...
    mutate(mobile_monitoring_ma200_ir_bc1 = mobile_monitoring_ma200_ir_bc1/1000) %>% #View()
