...
left_join(t1, t2) %>%
  ...
  kable(caption = "backup CO2 readings are dropped b/c they are different from collocated backup instrument. # of stops is the same b/c the primary instrumetn will be used.") %>%
  kable_styling()
...
left_join(t1, t2) %>%
  ...
  kable(caption = "all backup CO2 readings are dropped b/c they appear to be unreliable") %>%
  kable_styling()
